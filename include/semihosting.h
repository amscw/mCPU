...
#ifndef INCLUDE_SEMIHOSTING_H_
#define INCLUDE_SEMIHOSTING_H_
...
#ifdef __thumb__
#define AngelSWI                        0xAB	// номер SVC
#else
...
// SETEND - Set the endianness bit in the CPSR, without affecting any other bits in the CPSR.
// BE - big-endian
// CPSR - The Current Program Status Register (CPSR) holds processor status and control information
